...
if [[ -z ${PATH_GCCARM} ]]; then
  OBJCOPY="/home/miceuz/SimplicityStudio_v4/developer/toolchains/gnu_arm/4.9_2015q3/bin/arm-none-eabi-objcopy"
...
if [[ -z ${PATH_SCMD} ]]; then
  COMMANDER="/home/miceuz/SimplicityStudio_v4/developer/adapter_packs/commander/commander"
